    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form action="{{url('admin/profil-makam/tambah')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Masukkan data alamat" style="width: 25%" required>
                    </div>
                    <div class="form-group">
                        <label for="harga">Nomor Whatsapp</label>
                        <input type="number" class="form-control" id="whatsapp_contact" name="whatsapp_contact" placeholder="Masukkan nomor whatsapp" style="width: 25%" required>
                    </div>
                    <div class="form-group">
                        <label for="harga">Nomor HP</label>
                        <input type="number" class="form-control" id="whatsapp_contact" name="phone_contact" placeholder="Masukkan nomor HP" style="width: 25%">
                    </div>
                    <div class="form-group">
